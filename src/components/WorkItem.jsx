...
const WorkItem = ({imgUrl, title, tech, workUrl}) => {
  return (
    <a href={workUrl} target='_blank' rel='noreffer' className='bg-slate-300 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 hover:translate-y-2 transform transition rounded-lg overflow-hidden'>
